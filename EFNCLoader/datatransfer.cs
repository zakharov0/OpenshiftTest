...
namespace DataTransfer
{
    ...
    {  
        ...
        public string fleetmon_url{ get; set; }
        ...
        public string type_code{ get; set; }// "SPC",
        public int? imo_number{ get; set; }// 8723725,
        public string cn_name{ get; set; }// "Russia",
        public string vt_verbose{ get; set; }// "Special Purpose",
        public int? ais_type_of_ship{ get; set; }// 0,
        public long vessel_id{ get; set; }// 8753740
        ...
        public override string ToString()
        {
            return String.Format("{0}\t{1}\t{2}", vessel_id, name, position.received);
        }
